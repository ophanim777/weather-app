...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ \"./src/api.js\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\n\r\nconst form = document.getElementById(\"weather-form\");\r\nconst input = document.getElementById(\"location-input\");\r\nconst toggleBtn = document.getElementById(\"toggle-unit\");\r\n\r\nlet unit = \"metric\";\r\n\r\n\r\nform.addEventListener(\"submit\", async (e) => {\r\n  e.preventDefault();\r\n\r\n  const data = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.fetchWeatherData)(input.value, unit);\r\n  const weather = (0,_api__WEBPACK_IMPORTED_MODULE_0__.processWeatherData)(data);\r\n  console.log(weather);\r\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.renderWeather)(weather);\r\n});\r\n\r\ntoggleBtn.addEventListener(\"click\", async () => {\r\n  unit = unit === \"metric\" ? \"us\" : \"metric\";\r\n  if (input.value) {\r\n    const data = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.fetchWeatherData)(input.value, unit);\r\n    const weather = (0,_api__WEBPACK_IMPORTED_MODULE_0__.processWeatherData)(data);\r\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.renderWeather)(weather);\r\n  }\r\n});\r\n\r\n\n\n//# sourceURL=webpack:///./src/index.js?\n}");
